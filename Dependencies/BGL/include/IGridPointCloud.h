...
namespace GPP
{
    class BGL_EXPORT IGridPointCloud
    {
    public:
        IGridPointCloud() {}
        ...
        virtual bool HasGridNormal(void) const = 0;
        virtual void SetHasGridNormal(bool has) = 0;
        ...
        virtual Int GetValidGridCount(void) const = 0;
        virtual Vector3 GetValidGridCoord(Int gridId) const = 0;
        virtual Vector3 GetValidGridNormal(Int gridId) const = 0;
